...
const SPREADSHEET_ID = parseSpreadsheetId(process.env.SPREADSHEET_ID);
...
module.exports = { updateCurrentSheet, appendHistorySheet, buildRows, formatDatetime, parseSpreadsheetId };
